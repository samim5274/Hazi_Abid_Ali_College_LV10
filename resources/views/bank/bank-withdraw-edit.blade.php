...
<head>
    ...
    <title>Bank Withdraw - {{ $company->name }}</title>
    ...
    <div class="pc-container">
        <div class="pc-content">
            ...
            <div class="max-w-3xl mx-auto p-6 bg-white shadow-lg rounded-lg mt-6">
                ...
                <!-- Edit Form -->
                <form action="{{ url('/modify-bank-withdraw/'.$withdrawDetails->id) }}" method="POST">
                    @csrf
                    <div class="grid grid-cols-12 gap-6">
                            ...
                            <select name="bank_name" id="bank_name" required
                                ...
                                @foreach($bankDetails as $bank)
                                    <option value="{{ $bank->id }}" 
                                        {{ $withdrawDetails->bank_id == $bank->id ? 'selected' : '' }}>
                                        {{ $bank->bank_name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-span-12">
                            ...
                            <textarea name="remarks" id="remarks" rows="3" placeholder="Additional notes"
                                class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#3F4D67]">{{ $withdrawDetails->remarks }}</textarea>
                        </div>
                        ...
                        <div class="col-span-12 mt-4">
                            <button type="submit"
                                ...
                                onclick="return confirm('Are you sure you want to modify this withdraw?')">
