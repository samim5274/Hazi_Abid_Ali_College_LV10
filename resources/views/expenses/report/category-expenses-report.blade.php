    ...
    <div class="pc-container">
        <div class="pc-content">
            ...
            <div class="page-header mb-6">
                <div class="page-block">
                    <div class="page-header-title">
                        <h5 class="mb-1 font-semibold text-gray-800">Expense Category Report</h5>
                    </div>
                    <ul class="breadcrumb">
            ...
            <div class="bg-white rounded-xl shadow overflow-x-auto">
                <form method="GET" action="{{ url('/expenses-category-data-filter') }}" class="w-full bg-gray-50 p-6 rounded-lg shadow-md" target="_blank">
