...
<head>
    ...
    <title>Expenses Report - (SMS)</title>
    ...
    <div class="pc-container">
        <div class="pc-content">
            ...
            <div class="page-header mb-6">
                <div class="page-block">
                    <div class="page-header-title">
                        <h5 class="mb-1 font-semibold text-gray-800">Expense Sub-Category Report</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ url('/expense') }}">Expense</a></li>
                        <li class="breadcrumb-item" aria-current="page">Date wise Category Expense Report</li>
                    </ul>
                </div>
            </div>     
            ...
            <div class="bg-white rounded-xl shadow overflow-x-auto">
                <form method="GET" action="{{ url('/expenses-sub-category-data-filter') }}" class="w-full bg-gray-50 p-6 rounded-lg shadow-md" target="_blank">
                    <div class="flex flex-col md:flex-row md:items-end md:justify-between w-full gap-4">
                        ...
                        <!-- Sub-category -->
                        <div class="flex flex-col flex-1">
                            <select name="subcategory_id" id="subcategory_id" class="w-full border border-gray-300 rounded-lg px-4 py-2 
                                    focus:ring-2 focus:ring-indigo-300 focus:outline-none">
