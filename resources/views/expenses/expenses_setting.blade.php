        ...
        <div class="pc-content">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center flex justify-center gap-2">
                                <a href="{{ url('/edit-expenses-category/'.$val->id) }}" class="text-indigo-600">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>

                                <form action="{{ url('/delete-expenses-category/'.$val->id) }}" method="POST"
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $val->name }}</td>
                            <td class="text-center flex justify-center gap-2">
                                <a href="{{ url('/edit-expenses-subcategory/'.$val->id) }}" class="text-indigo-600">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>

                                <form action="{{ url('/delete-expenses-subcategory/'.$val->id) }}" method="POST"
                                    onsubmit="return confirm('Are you sure?')">
                                    @csrf
                                    <button class="text-red-600">
                                        <i class="fa-solid fa-trash"></i>
            ...
            <div id="SubCategoryModal" class="fixed inset-0 bg-black/50 hidden items-center justify-center z-50">
                <div class="bg-white rounded-lg shadow-lg w-full max-w-3xl p-6 relative">
                    ...
                    <form action="{{ url('/create-expenses-subcategory') }}" method="POST">
                        @csrf
