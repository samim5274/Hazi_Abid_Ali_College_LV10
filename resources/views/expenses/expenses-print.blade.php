...
<body>
    ...
    <div class="half-page">
        ...
        <div class="expense-card">
            ...
            <div class="expense-row">
                <div><span class="label">User:</span> {{ $expense->user->first_name ?? '' }} {{ $expense->user->last_name ?? '' }}</div>
                <div><span class="label">Category:</span> {{ $expense->category->name ?? 'N/A' }}</div>
            </div>

            <div class="expense-row">
                <div><span class="label">Subcategory:</span> {{ $expense->subcategory->name ?? 'N/A' }}</div>
            </div>
        ...
        <!-- Note -->
        <div class="note">
            Developed by <strong>BGMIT</strong> Created by <strong>SAMIM-HosseN</strong> | +880 1533-021557
        </div>
    </div>
