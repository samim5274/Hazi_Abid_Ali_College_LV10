            ...
            <div class="card rounded-lg border shadow-sm ">
                <div class="bg-gray-100 border-b px-4 py-4 sm:py-6 rounded-t-lg">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        ...
                        <a href="{{url('/promote-class/'.$students[0]->class_id ?? 'N/A')}}" class="px-4 py-3 text-md border border-gray-400 rounded-md bg-[#3F4D67] text-white hover:bg-[#54668a] transition-all duration-300"><i class="fa-solid fa-angles-up mr-3"></i>Migrate</a>
                        @else
