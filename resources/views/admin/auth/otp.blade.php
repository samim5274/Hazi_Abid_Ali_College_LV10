                ...
                <div class="w-full max-w-[350px] relative">
                    ...
                    <div class="card sm:my-12 w-full shadow-none">
                        <div class="card-body !p-10">
                            ...
                            <h4 class="text-center font-medium mb-4">Confirm OTP</h4>
                            
                            <form action="{{ url('/otp-verify') }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                    <input type="text" name="txtOTP" class="form-control" placeholder="Enter OTP number" required />
                                </div>
                                <div class="mt-4 text-center">
                                    <button type="submit" class="btn btn-primary mx-auto shadow-2xl w-full">Find Account</button>
                                </div>
                            </form>
                        </div>
                    </div>
