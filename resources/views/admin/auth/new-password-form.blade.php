...
<head>
    ...
    <title>Create new password - (SMS)</title>
                ...
                <div class="w-full max-w-[350px] relative">
                    ...
                    <div class="card sm:my-12 w-full shadow-none">
                        <div class="card-body !p-10">
                            ...
                            <h4 class="text-center font-medium mb-4">Create new password</h4>
                            ...
                            <form action="{{ url('/create-password') }}" method="POST">
                                ...
                                <div class="mt-4 text-center">
                                    <button type="submit" class="btn btn-primary mx-auto shadow-2xl w-full">Set Password</button>
                                </div>
                            </form>
                            <div class="text-center mt-4">
                                <a href="{{ url('/login') }}" class="text-blue-600 hover:underline text-sm">Back to Login</a>
                            </div>
                        </div>
                    </div>
