...
<div class="container">
    ...
    <div class="info-section">
        <div>
            ...
            <div><strong>Payment Date:</strong> {{ \Carbon\Carbon::parse($payment->payment_date)->format('d M, Y') }}</div>
            <div><strong>Payment Method:</strong> {{ $payment->payment_method ?? 'N/A' }}</div>
        </div>
        <div>
