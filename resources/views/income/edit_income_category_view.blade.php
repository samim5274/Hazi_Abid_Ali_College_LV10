    ...
    <div class="pc-container">
        <div class="pc-content">
            ...
            <div class="page-header mb-6">
                <div class="page-block">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('/income-setting') }}">Setting</a></li>
                        <li class="breadcrumb-item" aria-current="page">Modify Income Category</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="max-w-3xl bg-white p-6 rounded shadow">
                ...
                <form action="{{ url('/modify-income-category/'.$category->id) }}" method="POST">
                    @csrf
                    ...
                    <textarea name="remarks"
                        class="w-full border rounded px-4 py-2 mb-4">{{ $category->description }}</textarea>
