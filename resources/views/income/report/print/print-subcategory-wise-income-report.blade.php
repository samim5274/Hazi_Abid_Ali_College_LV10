...
<head>
    <meta charset="UTF-8">
    <title>Date Wise Income Report - {{ $company->name }}</title>
...
<div class="container">
    ...
    <div class="report-info">
        Sub-Category & Date Wise Income Report  
        <br>
        ...
        <tbody>
            ...
            @forelse($Incomes as $key => $Income)
                ...
                <tr>
                    ...
                    <td>{{ $Income->title }}</td>
                    <td>{{ $Income->user->first_name ?? '' }} {{ $Income->user->last_name ?? '' }}</td>
                    <td>{{ $Income->category->name ?? 'N/A' }}</td>
                    <td>{{ $Income->subcategory->name ?? 'N/A' }}</td>
    ...
    <div class="signature-section">
        <div class="signature-block">
            <span>{{ Auth::guard('teacher')->user()->first_name ?? 'System' }} {{ Auth::guard('teacher')->user()->last_name ?? 'System' }}</span>
            <div class="line"></div>
