            ...
            <!-- search section -->
             <div class="card rounded-md border shadow-md">
                <div class="card-body">
                    ...
                    <form action="#" method="GET" class="p-4" id="filter-form">
                    ...
                    @if ($teacher->hasPages())
                        <div class="flex flex-wrap items-center justify-between mt-4 w-full">
                            ...
                            <div class="text-sm md:text-base text-gray-600">
                                Page {{ $teacher->currentPage() }} of {{ $teacher->lastPage() }} 
                                (Total Records: {{ $teacher->total() }})
                            </div>
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                @else
                                    <a href="{{ $teacher->appends(request()->query())->previousPageUrl() }}" class="px-2 py-1 text-sm md:text-base bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 transition-colors">
                                        &laquo; 
                                    </a>
                                @endif
                                ...
                                {{-- Page Numbers --}}
                                @php
                                    $start = max(1, $teacher->currentPage() - 2);
                                ...
                                @for ($i = $start; $i <= $end; $i++)
                                    ...
                                    @else
                                        <a href="{{ $teacher->appends(request()->query())->url($i) }}" class="px-2 py-1 text-sm md:text-base bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 transition-colors">{{ $i }}</a>
                                    @endif
                                @endfor

                                {{-- Next Button --}}
                                @if ($teacher->hasMorePages())
                                    <a href="{{ $teacher->appends(request()->query())->nextPageUrl() }}" class="px-2 py-1 text-sm md:text-base bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 transition-colors">
                                        &raquo;
                                    </a>
                                @else
                                    <span class="px-2 py-1 text-sm md:text-base bg-gray-200 text-gray-500 rounded-lg cursor-not-allowed">
